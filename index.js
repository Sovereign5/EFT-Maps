...
app.get("/Interchange", async function(req, res) {
	res.render("Interchange");
});

app.get("/Woods", async function(req, res) {
	res.render("Woods");
});

app.get("/Shoreline", async function(req, res) {
	res.render("Shoreline");
})

app.get("/Customs", async function(req, res) {
	res.render("Customs");
});
